        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Heading = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentStatus = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Timestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_FullName_CreatedAt",
                table: "Customers",
                columns: new[] { "FullName", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drivers_Name_CreatedAt_CurrentStatus",
                table: "Drivers",
                columns: new[] { "Name", "CreatedAt", "CurrentStatus" });
